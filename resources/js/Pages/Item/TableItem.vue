...
<b-container fluid>
    ...
    <!-- Main table element -->
    <b-table :items="items" :fields="fields" :current-page="filters.current_page" :per-page="filters.per_page" :search="search" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :sort-direction="sortDirection" stacked="md" show-empty small>
        ...
        <template #cell(action)="data">
            <b-button @click="selectChild(data.item)" v-b-modal.item-form-modal variant="primary">Update</b-button>
        </template>
